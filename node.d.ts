...
declare namespace $ {
    ...
    class $bog_gamengine_point extends $mol_object2 {
        ...
        box_from: Float32Array<ArrayBuffer>;
        box_to: Float32Array<ArrayBuffer>;
        box_hits: $bog_gamengine_node[];
        pick_box(nodes: readonly $bog_gamengine_node[], x0: number, y0: number, x1: number, y1: number, out?: number[]): readonly $bog_gamengine_node[];
...
declare namespace $ {
    ...
    class $bog_gamengine_text extends $bog_gamengine_node {
        pool_own(next?: $bog_gamengine_text_pool): $bog_gamengine_text_pool;
...
declare namespace $ {
	...
	>
	type $bog_gamengine_point__scale_bog_gamengine_demo_flat_30 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['draw_dpr'] >
		,
		ReturnType< $bog_gamengine_point['scale'] >
	>
	type $bog_gamengine_sound__uris_bog_gamengine_demo_flat_31 = $mol_type_enforce<
		({ 
			'coin': string,
		}) 
		,
	...
	>
	type $bog_gamengine_scene__clock_bog_gamengine_demo_flat_32 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Clock'] >
		,
		ReturnType< $bog_gamengine_scene['clock'] >
	>
	type $bog_gamengine_scene__input_bog_gamengine_demo_flat_33 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Input'] >
		,
		ReturnType< $bog_gamengine_scene['input'] >
	>
	type $bog_gamengine_scene__kids_bog_gamengine_demo_flat_34 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['nodes'] >
		,
		ReturnType< $bog_gamengine_scene['kids'] >
	>
	type $bog_gamengine_scene__phys_bog_gamengine_demo_flat_35 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Phys'] >
		,
		ReturnType< $bog_gamengine_scene['phys'] >
	>
	type $bog_gamengine_scene__batches_bog_gamengine_demo_flat_36 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['batches'] >
		,
		ReturnType< $bog_gamengine_scene['batches'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_flat_37 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Sprite_shader'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_flat_38 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__nodes_bog_gamengine_demo_flat_39 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['sprites'] >
		,
		ReturnType< $bog_gamengine_batch['nodes'] >
	>
	type $bog_gamengine_cam_flat__height_bog_gamengine_demo_flat_40 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_cam_flat['height'] >
	>
	type $bog_gamengine_cam_flat__pos_bog_gamengine_demo_flat_41 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['cam_pos'] >
		,
		ReturnType< $bog_gamengine_cam_flat['pos'] >
	>
	type $bog_gamengine_tilemap__tile_bog_gamengine_demo_flat_42 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Tile'] >
		,
		ReturnType< $bog_gamengine_tilemap['tile'] >
	>
	type $bog_gamengine_tilemap__atlas_bog_gamengine_demo_flat_43 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_tilemap['atlas'] >
	>
	type $bog_gamengine_tilemap__palette_bog_gamengine_demo_flat_44 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['palette'] >
		,
		ReturnType< $bog_gamengine_tilemap['palette'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_flat_45 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Sprite_shader'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_flat_46 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__source_bog_gamengine_demo_flat_47 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['tilemap_pool'] >
		,
		ReturnType< $bog_gamengine_batch['source'] >
	>
	type $bog_gamengine_demo_flat_hero__input_bog_gamengine_demo_flat_48 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Input'] >
		,
		ReturnType< $bog_gamengine_demo_flat_hero['input'] >
	>
	type $bog_gamengine_demo_flat_hero__pos_bog_gamengine_demo_flat_49 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['hero_pos'] >
		,
		ReturnType< $bog_gamengine_demo_flat_hero['pos'] >
	>
	type $bog_gamengine_sprite__parent_bog_gamengine_demo_flat_50 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Hero'] >
		,
		ReturnType< $bog_gamengine_sprite['parent'] >
	>
	type $bog_gamengine_sprite__atlas_bog_gamengine_demo_flat_51 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_sprite['atlas'] >
	>
	type $bog_gamengine_sprite__frame_bog_gamengine_demo_flat_52 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_sprite['frame'] >
	>
	type $bog_gamengine_sprite__flip_x_bog_gamengine_demo_flat_53 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['hero_face_left'] >
		,
		ReturnType< $bog_gamengine_sprite['flip_x'] >
	>
	type $bog_gamengine_sprite__clock_bog_gamengine_demo_flat_54 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Clock'] >
		,
		ReturnType< $bog_gamengine_sprite['clock'] >
	>
	type $bog_gamengine_sprite__clip_bog_gamengine_demo_flat_55 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['hero_clip'] >
		,
		ReturnType< $bog_gamengine_sprite['clip'] >
	>
	type $bog_gamengine_sprite__fps_bog_gamengine_demo_flat_56 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_sprite['fps'] >
	>
	type $bog_gamengine_sprite__clips_bog_gamengine_demo_flat_57 = $mol_type_enforce<
		({ 
			'walk': readonly(any)[],
		}) 
		,
	...
	>
	type $bog_gamengine_nav_grid__tile_bog_gamengine_demo_flat_58 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Tile'] >
		,
		ReturnType< $bog_gamengine_nav_grid['tile'] >
	>
	type $bog_gamengine_nav_agent__grid_bog_gamengine_demo_flat_59 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Grid'] >
		,
		ReturnType< $bog_gamengine_nav_agent['grid'] >
	>
	type $bog_gamengine_nav_agent__target_bog_gamengine_demo_flat_60 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['hero_pos'] >
		,
		ReturnType< $bog_gamengine_nav_agent['target'] >
	>
	type $bog_gamengine_nav_agent__pos_bog_gamengine_demo_flat_61 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['ghost_pos'] >
		,
		ReturnType< $bog_gamengine_nav_agent['pos'] >
	>
	type $bog_gamengine_sprite__parent_bog_gamengine_demo_flat_62 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Ghost'] >
		,
		ReturnType< $bog_gamengine_sprite['parent'] >
	>
	type $bog_gamengine_sprite__atlas_bog_gamengine_demo_flat_63 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_sprite['atlas'] >
	>
	type $bog_gamengine_sprite__frame_bog_gamengine_demo_flat_64 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_sprite['frame'] >
	>
	type $bog_gamengine_sprite__tint_bog_gamengine_demo_flat_65 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['ghost_tint'] >
		,
		ReturnType< $bog_gamengine_sprite['tint'] >
	>
	type $bog_gamengine_demo_flat_coin__sound_bog_gamengine_demo_flat_66 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Sound'] >
		,
		ReturnType< $bog_gamengine_demo_flat_coin['sound'] >
	>
	type $bog_gamengine_demo_flat_coin__pos_bog_gamengine_demo_flat_67 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['coin_pos'] >
		,
		ReturnType< $bog_gamengine_demo_flat_coin['pos'] >
	>
	type $bog_gamengine_sprite__parent_bog_gamengine_demo_flat_68 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Coin'] >
		,
		ReturnType< $bog_gamengine_sprite['parent'] >
	>
	type $bog_gamengine_sprite__atlas_bog_gamengine_demo_flat_69 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Atlas'] >
		,
		ReturnType< $bog_gamengine_sprite['atlas'] >
	>
	type $bog_gamengine_sprite__frame_bog_gamengine_demo_flat_70 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_sprite['frame'] >
	>
	type $bog_gamengine_text_font__size_bog_gamengine_demo_flat_71 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_text_font['size'] >
	>
	type $bog_gamengine_text_font__chars_bog_gamengine_demo_flat_72 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_text_font['chars'] >
	>
	type $bog_gamengine_atlas__size_bog_gamengine_demo_flat_73 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_atlas['size'] >
	>
	type $bog_gamengine_atlas__sources_bog_gamengine_demo_flat_74 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['font_sources'] >
		,
		ReturnType< $bog_gamengine_atlas['sources'] >
	>
	type $bog_gamengine_text__font_bog_gamengine_demo_flat_75 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Font'] >
		,
		ReturnType< $bog_gamengine_text['font'] >
	>
	type $bog_gamengine_text__atlas_bog_gamengine_demo_flat_76 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Font_atlas'] >
		,
		ReturnType< $bog_gamengine_text['atlas'] >
	>
	type $bog_gamengine_text__value_bog_gamengine_demo_flat_77 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_text['value'] >
	>
	type $bog_gamengine_text__height_bog_gamengine_demo_flat_78 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_text['height'] >
	>
	type $bog_gamengine_text__align_bog_gamengine_demo_flat_79 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_text['align'] >
	>
	type $bog_gamengine_text__color_bog_gamengine_demo_flat_80 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['coin_text_color'] >
		,
		ReturnType< $bog_gamengine_text['color'] >
	>
	type $bog_gamengine_text__pos_bog_gamengine_demo_flat_81 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['coin_text_pos'] >
		,
		ReturnType< $bog_gamengine_text['pos'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_flat_82 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Sprite_shader'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_flat_83 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_flat['Font_atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__source_bog_gamengine_demo_flat_84 = $mol_type_enforce<
	...
	export class $bog_gamengine_demo_flat extends $mol_page {
		...
		draw_dpr( ): ReturnType< ReturnType< $bog_gamengine_demo_flat['Draw'] >['dpr'] >
...
declare namespace $ {
    class $bog_gamengine_mesh_skin extends $bog_gamengine_mesh {
        skin(next?: $bog_gamengine_skin | null): $bog_gamengine_skin | null;
        Shader(): $bog_gamengine_shader_skin;
        shader(next?: $bog_gamengine_shader | null): $bog_gamengine_shader | $bog_gamengine_shader_skin;
        shape(next?: $bog_gamengine_shape): $bog_gamengine_shape;
        bones(): Float32Array<ArrayBuffer> | null;
        step(dt: number): void;
    }
}
...
declare namespace $ {
	...
	type $mol_check_box__checked_bog_gamengine_demo_room_10 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['fogged'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	...
	type $mol_check_box__checked_bog_gamengine_demo_room_12 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['arm_shown'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	...
	type $mol_check_box__checked_bog_gamengine_demo_room_14 = $mol_type_enforce<
		...
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_check_box__title_bog_gamengine_demo_room_15 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_bog_gamengine_demo_room_16 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['screen_shown'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type $mol_check_box__title_bog_gamengine_demo_room_17 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_box['title'] >
	>
	type $mol_check_box__checked_bog_gamengine_demo_room_18 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['profile'] >
		,
		ReturnType< $mol_check_box['checked'] >
	>
	type __bog_gamengine_demo_room_19 = $mol_type_enforce<
		Parameters< $bog_gamengine_demo_room['wireframe'] >[0]
		,
		Parameters< ReturnType< $bog_gamengine_demo_room['Draw'] >['wireframe'] >[0]
	>
	type __bog_gamengine_demo_room_20 = $mol_type_enforce<
		Parameters< $bog_gamengine_demo_room['shadows'] >[0]
		,
		Parameters< ReturnType< $bog_gamengine_demo_room['Draw'] >['shadows'] >[0]
	>
	type $bog_gamengine_draw__scene_bog_gamengine_demo_room_21 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Scene'] >
		,
		ReturnType< $bog_gamengine_draw['scene'] >
	>
	type $bog_gamengine_draw__cam_bog_gamengine_demo_room_22 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Walker'] >
		,
		ReturnType< $bog_gamengine_draw['cam'] >
	>
	type $bog_gamengine_draw__fog_bog_gamengine_demo_room_23 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['fog'] >
		,
		ReturnType< $bog_gamengine_draw['fog'] >
	>
	type $bog_gamengine_draw__fog_color_bog_gamengine_demo_room_24 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['fog_color'] >
		,
		ReturnType< $bog_gamengine_draw['fog_color'] >
	>
	type $bog_gamengine_draw__passes_bog_gamengine_demo_room_25 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['passes'] >
		,
		ReturnType< $bog_gamengine_draw['passes'] >
	>
	type $bog_gamengine_input_screen__shown_bog_gamengine_demo_room_26 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['screen_shown'] >
		,
		ReturnType< $bog_gamengine_input_screen['shown'] >
	>
	type $bog_gamengine_input_screen__bind_bog_gamengine_demo_room_27 = $mol_type_enforce<
		({ 
			'left': readonly(any)[],
			'right': readonly(any)[],
	...
	>
	type $bog_gamengine_input_screen__actions_bog_gamengine_demo_room_28 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_gamengine_input_screen['actions'] >
	>
	type $bog_gamengine_input_screen__titles_bog_gamengine_demo_room_29 = $mol_type_enforce<
		({ 
			'turn_left': string,
			'turn_right': string,
		}) 
	...
	>
	type $mol_view__sub_bog_gamengine_demo_room_30 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_gamengine_demo_room_31 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_gamengine_demo_room_32 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_gamengine_demo_room_33 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_gamengine_demo_room_34 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_35 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_36 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_37 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_38 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_39 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_40 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_41 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_42 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_43 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_44 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_45 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_46 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_47 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_48 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_49 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_50 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_51 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_52 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type $mol_labeler__title_bog_gamengine_demo_room_53 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_labeler['title'] >
	>
	type $mol_labeler__content_bog_gamengine_demo_room_54 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_labeler['content'] >
	>
	type __bog_gamengine_demo_room_55 = $mol_type_enforce<
		Parameters< $bog_gamengine_demo_room['paused'] >[0]
		,
		Parameters< ReturnType< $bog_gamengine_demo_room['Clock'] >['paused'] >[0]
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_room_56 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Solid'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__shape_bog_gamengine_demo_room_57 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Box'] >
		,
		ReturnType< $bog_gamengine_batch['shape'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_room_58 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__nodes_bog_gamengine_demo_room_59 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['walls'] >
		,
		ReturnType< $bog_gamengine_batch['nodes'] >
	>
	type $bog_gamengine_shape_plane__tile_bog_gamengine_demo_room_60 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['floor_tile'] >
		,
		ReturnType< $bog_gamengine_shape_plane['tile'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_room_61 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Solid'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__shape_bog_gamengine_demo_room_62 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Plane'] >
		,
		ReturnType< $bog_gamengine_batch['shape'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_room_63 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__nodes_bog_gamengine_demo_room_64 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_gamengine_batch['nodes'] >
	>
	type $bog_gamengine_shape_gltf__data_bog_gamengine_demo_room_65 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['pillar_data'] >
		,
		ReturnType< $bog_gamengine_shape_gltf['data'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_room_66 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Solid'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__shape_bog_gamengine_demo_room_67 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Pillar_shape'] >
		,
		ReturnType< $bog_gamengine_batch['shape'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_room_68 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__nodes_bog_gamengine_demo_room_69 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_gamengine_batch['nodes'] >
	>
	type $bog_gamengine_shape_gltf__data_bog_gamengine_demo_room_70 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['arm_data'] >
		,
		ReturnType< $bog_gamengine_shape_gltf['data'] >
	>
	type $bog_gamengine_batch__shader_bog_gamengine_demo_room_71 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Skin'] >
		,
		ReturnType< $bog_gamengine_batch['shader'] >
	>
	type $bog_gamengine_batch__shape_bog_gamengine_demo_room_72 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Arm_shape'] >
		,
		ReturnType< $bog_gamengine_batch['shape'] >
	>
	type $bog_gamengine_batch__atlas_bog_gamengine_demo_room_73 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_batch['atlas'] >
	>
	type $bog_gamengine_batch__nodes_bog_gamengine_demo_room_74 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['arm_nodes'] >
		,
		ReturnType< $bog_gamengine_batch['nodes'] >
	>
	type $bog_gamengine_skin__shape_bog_gamengine_demo_room_75 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Arm_shape'] >
		,
		ReturnType< $bog_gamengine_skin['shape'] >
	>
	type $bog_gamengine_skin__clip_bog_gamengine_demo_room_76 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_skin['clip'] >
	>
	type $mol_view__sub_bog_gamengine_demo_room_77 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_gamengine_input__key_bog_gamengine_demo_room_78 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Key'] >
		,
		ReturnType< $bog_gamengine_input['key'] >
	>
	type $bog_gamengine_input__screen_bog_gamengine_demo_room_79 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Screen'] >
		,
		ReturnType< $bog_gamengine_input['screen'] >
	>
	type $bog_gamengine_key__bind_bog_gamengine_demo_room_80 = $mol_type_enforce<
		({ 
			'forward': readonly(any)[],
			'back': readonly(any)[],
			'left': readonly(any)[],
		...
		ReturnType< $bog_gamengine_key['bind'] >
	>
	type $bog_gamengine_phys_tile__map_bog_gamengine_demo_room_81 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['map'] >
		,
		ReturnType< $bog_gamengine_phys_tile['map'] >
	>
	type $bog_gamengine_atlas__uris_bog_gamengine_demo_room_82 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_gamengine_atlas['uris'] >
	>
	type $bog_gamengine_atlas__size_bog_gamengine_demo_room_83 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_atlas['size'] >
	>
	type $bog_gamengine_scene__clock_bog_gamengine_demo_room_84 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Clock'] >
		,
		ReturnType< $bog_gamengine_scene['clock'] >
	>
	type $bog_gamengine_scene__input_bog_gamengine_demo_room_85 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Input'] >
		,
		ReturnType< $bog_gamengine_scene['input'] >
	>
	type $bog_gamengine_scene__kids_bog_gamengine_demo_room_86 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['nodes'] >
		,
		ReturnType< $bog_gamengine_scene['kids'] >
	>
	type $bog_gamengine_scene__batches_bog_gamengine_demo_room_87 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $bog_gamengine_scene['batches'] >
	>
	type $bog_gamengine_mesh_skin__skin_bog_gamengine_demo_room_88 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Arm_skin'] >
		,
		ReturnType< $bog_gamengine_mesh_skin['skin'] >
	>
	type $bog_gamengine_mesh_skin__atlas_bog_gamengine_demo_room_89 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_mesh_skin['atlas'] >
	>
	type $bog_gamengine_mesh_skin__frame_bog_gamengine_demo_room_90 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_mesh_skin['frame'] >
	>
	type $bog_gamengine_mesh_skin__pos_bog_gamengine_demo_room_91 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['arm_pos'] >
		,
		ReturnType< $bog_gamengine_mesh_skin['pos'] >
	>
	type $bog_gamengine_mesh__shape_bog_gamengine_demo_room_92 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Box'] >
		,
		ReturnType< $bog_gamengine_mesh['shape'] >
	>
	type $bog_gamengine_mesh__atlas_bog_gamengine_demo_room_93 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_mesh['atlas'] >
	>
	type $bog_gamengine_mesh__frame_bog_gamengine_demo_room_94 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_mesh['frame'] >
	>
	type $bog_gamengine_mesh__pos_bog_gamengine_demo_room_95 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['wall_pos'] >
		,
		ReturnType< $bog_gamengine_mesh['pos'] >
	>
	type $bog_gamengine_mesh__material_bog_gamengine_demo_room_96 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['wall_material'] >
		,
		ReturnType< $bog_gamengine_mesh['material'] >
	>
	type $bog_gamengine_mesh__shape_bog_gamengine_demo_room_97 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Plane'] >
		,
		ReturnType< $bog_gamengine_mesh['shape'] >
	>
	type $bog_gamengine_mesh__atlas_bog_gamengine_demo_room_98 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_mesh['atlas'] >
	>
	type $bog_gamengine_mesh__frame_bog_gamengine_demo_room_99 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_mesh['frame'] >
	>
	type $bog_gamengine_mesh__pos_bog_gamengine_demo_room_100 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['floor_pos'] >
		,
		ReturnType< $bog_gamengine_mesh['pos'] >
	>
	type $bog_gamengine_mesh__size_bog_gamengine_demo_room_101 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['floor_size'] >
		,
		ReturnType< $bog_gamengine_mesh['size'] >
	>
	type $bog_gamengine_mesh__shape_bog_gamengine_demo_room_102 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Pillar_shape'] >
		,
		ReturnType< $bog_gamengine_mesh['shape'] >
	>
	type $bog_gamengine_mesh__atlas_bog_gamengine_demo_room_103 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Atlas'] >
		,
		ReturnType< $bog_gamengine_mesh['atlas'] >
	>
	type $bog_gamengine_mesh__frame_bog_gamengine_demo_room_104 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_mesh['frame'] >
	>
	type $bog_gamengine_mesh__pos_bog_gamengine_demo_room_105 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['pillar_pos'] >
		,
		ReturnType< $bog_gamengine_mesh['pos'] >
	>
	type $bog_gamengine_demo_room_walker__input_bog_gamengine_demo_room_106 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Input'] >
		,
		ReturnType< $bog_gamengine_demo_room_walker['input'] >
	>
	type $bog_gamengine_demo_room_walker__tile_bog_gamengine_demo_room_107 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Tile'] >
		,
		ReturnType< $bog_gamengine_demo_room_walker['tile'] >
	>
	type $bog_gamengine_demo_room_walker__pos_bog_gamengine_demo_room_108 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['walker_pos'] >
		,
		ReturnType< $bog_gamengine_demo_room_walker['pos'] >
	>
	type $bog_gamengine_demo_room_walker__rot_bog_gamengine_demo_room_109 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['walker_rot'] >
		,
		ReturnType< $bog_gamengine_demo_room_walker['rot'] >
	>
	type $bog_gamengine_light__kind_bog_gamengine_demo_room_110 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_light['kind'] >
	>
	type $bog_gamengine_light__rot_bog_gamengine_demo_room_111 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['sun_rot'] >
		,
		ReturnType< $bog_gamengine_light['rot'] >
	>
	type $bog_gamengine_light__power_bog_gamengine_demo_room_112 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['power'] >
	>
	type $bog_gamengine_light__kind_bog_gamengine_demo_room_113 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_light['kind'] >
	>
	type $bog_gamengine_light__pos_bog_gamengine_demo_room_114 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['light_warm_pos'] >
		,
		ReturnType< $bog_gamengine_light['pos'] >
	>
	type $bog_gamengine_light__color_bog_gamengine_demo_room_115 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['light_warm_color'] >
		,
		ReturnType< $bog_gamengine_light['color'] >
	>
	type $bog_gamengine_light__power_bog_gamengine_demo_room_116 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['power'] >
	>
	type $bog_gamengine_light__range_bog_gamengine_demo_room_117 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['range'] >
	>
	type $bog_gamengine_light__kind_bog_gamengine_demo_room_118 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_light['kind'] >
	>
	type $bog_gamengine_light__pos_bog_gamengine_demo_room_119 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['light_cold_pos'] >
		,
		ReturnType< $bog_gamengine_light['pos'] >
	>
	type $bog_gamengine_light__color_bog_gamengine_demo_room_120 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['light_cold_color'] >
		,
		ReturnType< $bog_gamengine_light['color'] >
	>
	type $bog_gamengine_light__power_bog_gamengine_demo_room_121 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['power'] >
	>
	type $bog_gamengine_light__range_bog_gamengine_demo_room_122 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['range'] >
	>
	type $bog_gamengine_light__kind_bog_gamengine_demo_room_123 = $mol_type_enforce<
		string
		,
		ReturnType< $bog_gamengine_light['kind'] >
	>
	type $bog_gamengine_light__parent_bog_gamengine_demo_room_124 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['Walker'] >
		,
		ReturnType< $bog_gamengine_light['parent'] >
	>
	type $bog_gamengine_light__rot_bog_gamengine_demo_room_125 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_room['torch_rot'] >
		,
		ReturnType< $bog_gamengine_light['rot'] >
	>
	type $bog_gamengine_light__power_bog_gamengine_demo_room_126 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['power'] >
	>
	type $bog_gamengine_light__range_bog_gamengine_demo_room_127 = $mol_type_enforce<
		number
		,
		ReturnType< $bog_gamengine_light['range'] >
	>
	type $bog_gamengine_light__angle_bog_gamengine_demo_room_128 = $mol_type_enforce<
		number
		,
	...
	export class $bog_gamengine_demo_room extends $mol_page {
		...
		fogged( next?: boolean ): boolean
		Fog_check( ): $mol_check_box
		arm_shown( next?: boolean ): boolean
		Arm_check( ): $mol_check_box
		Pause( ): $mol_check_box
		screen_shown( next?: boolean ): boolean
		Screen_switch( ): $mol_check_box
		...
		Skin( ): $bog_gamengine_shader_skin
		arm_data( ): ArrayBuffer
		Arm_shape( ): $bog_gamengine_shape_gltf
		arm_nodes( ): readonly(any)[]
		Arm_batch( ): $bog_gamengine_batch
		Arm_skin( ): $bog_gamengine_skin
		arm_pos( ): Float32Array
...
declare namespace $.$$ {
    class $bog_gamengine_demo_room extends $.$bog_gamengine_demo_room {
        ...
        profile(next?: boolean): boolean;
        fogged(next?: boolean): boolean;
        fog(): Float32Array<ArrayBuffer>;
        fog_color(): Float32Array<ArrayBuffer>;
        ...
        arm_data(): ArrayBuffer;
        arm_pos(): Float32Array<ArrayBuffer>;
        arm_nodes(): $bog_gamengine_mesh_skin[];
        ...
        nodes(): ($bog_gamengine_light | $bog_gamengine_mesh | $bog_gamengine_demo_room_walker | $bog_gamengine_mesh_skin)[];
        pillar_stat(): string;
        arm_stat(): string;
        walker_stat(): string;
        light_stat(): string;
...
declare namespace $ {
    class $bog_gamengine_phys3_body extends $bog_gamengine_node {
        ...
        ghost(next?: boolean): boolean;
        kinematic(next?: boolean): boolean;
        handle_last: number;
        world_last: $bog_gamengine_phys3 | null;
        mass_now: number;
        ghost_now: boolean | null;
        kinematic_now: boolean | null;
        pos_out: Float32Array<ArrayBuffer>;
        rot_out: Float32Array<ArrayBuffer>;
        rot_tmp: Float32Array<ArrayBuffer>;
        mass_set(next: number): void;
        ghost_set(next: boolean): void;
        kinematic_set(next: boolean): void;
        handle(): number;
        index(): number;
        alive(): boolean;
...
declare namespace $ {
    class $bog_gamengine_demo_boxes_platform extends $bog_gamengine_phys3_body {
        span(next?: number): number;
        speed(next?: number): number;
        center(next?: Float32Array): Float32Array<ArrayBufferLike>;
        way: number;
        step(dt: number): void;
    }
}
...
declare namespace $ {
    type $bog_gamengine_phys3_cast_world = {
        count: number;
        pos: Float32Array;
        rot: Float32Array;
        shape: Uint8Array;
    ...
    type $bog_gamengine_phys3_cast_opts = {
        skip_ghost?: boolean;
    ...
    class $bog_gamengine_phys3_cast extends $mol_object2 {
        ...
        world: $bog_gamengine_phys3_cast_world;
        shape: Uint8Array<ArrayBuffer>;
        size: Float32Array<ArrayBuffer>;
        pos: Float32Array<ArrayBuffer>;
        rot: Float32Array<ArrayBuffer>;
        hoff: Uint32Array<ArrayBuffer>;
        hcnt: Uint32Array<ArrayBuffer>;
        skip_ghost: boolean;
        skip_one: number;
        skip_list: readonly number[] | null;
        ud: Float32Array<ArrayBuffer>;
        origin: Float32Array<ArrayBuffer>;
        hit: Float32Array<ArrayBuffer>;
        box_lo: Float32Array<ArrayBuffer>;
        box_hi: Float32Array<ArrayBuffer>;
        lo: Float32Array<ArrayBuffer>;
        ld: Float32Array<ArrayBuffer>;
        ln: Float32Array<ArrayBuffer>;
        pn: Float32Array<ArrayBuffer>;
        tmp: Float32Array<ArrayBuffer>;
        v: Float64Array<ArrayBuffer>;
        wa: Float64Array<ArrayBuffer>;
        wb: Float64Array<ArrayBuffer>;
        pb: Float64Array<ArrayBuffer>;
        last: Float64Array<ArrayBuffer>;
        sw: Float64Array<ArrayBuffer>;
        sa: Float64Array<ArrayBuffer>;
        sb: Float64Array<ArrayBuffer>;
        sn: number;
        keep: Int32Array<ArrayBuffer>;
        coef: Float64Array<ArrayBuffer>;
        keep_n: number;
        best_keep: Int32Array<ArrayBuffer>;
        best_coef: Float64Array<ArrayBuffer>;
        best_n: number;
        opts_read(opts?: $bog_gamengine_phys3_cast_opts): void;
        skipped(i: number): boolean;
        ray(world: $bog_gamengine_phys3_cast_world, origin: Float32Array, dir: Float32Array, max: number, out: Float32Array, opts?: $bog_gamengine_phys3_cast_opts): number;
        sweep(world: $bog_gamengine_phys3_cast_world, shape: number, size: Float32Array, origin: Float32Array, rot: Float32Array, dir: Float32Array, max: number, out: Float32Array, opts?: $bog_gamengine_phys3_cast_opts): number;
        load(s: number, i: number): void;
        bounds(max: number): void;
        slab(i: number, max: number): boolean;
        rotate(out: Float32Array | Float64Array, s: number, x: number, y: number, z: number, inv: boolean): Float32Array<ArrayBufferLike> | Float64Array<ArrayBufferLike>;
        support(s: number, dx: number, dy: number, dz: number, out: Float32Array | Float64Array): Float32Array<ArrayBufferLike> | Float64Array<ArrayBufferLike>;
        record(t: number, px: number, py: number, pz: number, nx: number, ny: number, nz: number): number;
        ray_sphere(limit: number): number;
        local(): void;
        local_hit(t: number, nx: number, ny: number, nz: number): number;
        ray_box(limit: number): number;
        ray_capsule(limit: number): number;
        sweep_plane(limit: number): number;
        advance(limit: number): number;
        gjk(): number;
        reduce(): boolean;
        segment(i: number, j: number): number;
        triangle(i: number, j: number, k: number): number;
        outside(i: number, j: number, k: number, l: number): boolean;
        tetra(): boolean;
    }
}
...
declare namespace $ {
	...
	type $bog_gamengine_draw__event_bog_gamengine_demo_boxes_18 = $mol_type_enforce<
		({ 
			...
			contextmenu( next?: ReturnType< $bog_gamengine_demo_boxes['dig'] > ): ReturnType< $bog_gamengine_demo_boxes['dig'] >,
		}) 
		,
		ReturnType< $bog_gamengine_draw['event'] >
	>
	...
	type $bog_gamengine_shape_plane__tile_bog_gamengine_demo_boxes_25 = $mol_type_enforce<
		ReturnType< $bog_gamengine_demo_boxes['floor_tile'] >
		,
		ReturnType< $bog_gamengine_shape_plane['tile'] >
	>
	...
	export class $bog_gamengine_demo_boxes extends $mol_page {
		...
		Platform( id: any): $bog_gamengine_demo_boxes_platform
		Walker( ): $bog_gamengine_demo_room_walker
	}
...
declare namespace $.$$ {
    ...
    class $bog_gamengine_demo_boxes extends $.$bog_gamengine_demo_boxes {
        ...
        Phys(): $bog_gamengine_demo_boxes_phys;
        floor_handle: number;
        platform_size(): Float32Array<ArrayBuffer>;
        platform(): $bog_gamengine_demo_boxes_platform;
        floor_size(): Float32Array<ArrayBuffer>;
        floor_tile(): Float32Array<ArrayBuffer>;
        walker_pos(next?: Float32Array): Float32Array<ArrayBufferLike>;
        walker_rot(next?: Float32Array): Float32Array<ArrayBufferLike>;
        ...
        dig_hit: Float32Array<ArrayBuffer>;
        dig_opts: {
            skip_ghost: boolean;
            skip: number;
        };
        dig_cast: $bog_gamengine_phys3_cast;
        dig(next?: MouseEvent | null): MouseEvent | null;
